...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/adduser.css"></link>
...
<div class="header" id="table">
    ...
    <form class="contact_form"  method="post" name="contact_form" >
		<ul>
			<li>
				...
				<input type="text" name="bookNo" disabled="disabled" placeholder="<%=request.getParameter("bookNo") %>"/>
			</li>
			<li>
				<label for="name">書籍名:</label>
				<input type="text" name="title" placeholder="書籍名入力し" required />
				<span class="form_hint">タイトル</span>
			</li>
			<li>
				<label for="name">プロット:</label>
				<input type="text" name="plot" placeholder="プロット入力し" required/>
			</li>
		 <dt>
			${modifybook}
         </dt>
  ...
  <script type="text/javascript">
	function submit()
    {
	var bookNo = <%=request.getParameter("bookNo")%>
	document.forms[0].action = "modifyBook.action?bookNo="+Number(bookNo); 
