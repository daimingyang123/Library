...
<div class="wrapper" >
  <div id="heading"><a href="admin.action"><img src="images/leftAlt3.png" alt="" id="previous" /></a>
    ...
    <a href="listUser.action"><img src="images/rightAlt3.png" alt="" id="next" /></a>
     </div>
  <div id="panes">
    <div id="content">
...
<form  name="AddStudentForm"  action="main.action" method="post">
  第${pageIndex}页&nbsp;
  共${pageCount}页&nbsp;
...
<form  name="AddStudentForm"  action="main.action" method="post">
  第${pageIndex}页&nbsp;
  共${pageCount}页&nbsp;
  <a href="main.action?pageIndex=1">首页</a>
  <logic:greaterThan name="pageIndex" scope="request" value="1">
  ...
  <a href="main.action?pageIndex=${requestScope.pageCount}">尾页</a>&nbsp;跳到<input size="4" type="text" name="pageIndex" id="pageIndex"/>页 <input type="submit" value="遷移" />
</form>
  </div>
      </div>
    </div>
